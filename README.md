...
Get oriented on the Nautilus cluster, log in to the hosted JupyterHub, and learn `kubectl` basics through hands-on creation of every core Kubernetes object researchers and educators need: simple pods, PersistentVolumeClaims, Deployments, Batch Jobs, an HTTPS-fronted Service via Ingress, and finally a GPU pod.
